...
const Home = () => {
  ...
  return (<div class="bg-gradient-to-b from-[#DDD5F5] to-[#FFFFFF] h-screen w-full">
    ...
    <div class="flex flex-col place-items-start py-8 px-8">
    <h2 class="text-black mb-4 font-semibold">Praise Songs</h2>
    <div class="flex flex-row">
      <img src={praiseImage} class="rounded-lg h-14 w-14"></img>
    <span class="text-left px-5 text-sm">Praise songs to lead the church in vibrant worship and glorify God’s name!</span>
    </div>
    <button  onClick={() => navigate("/PraiseSongs")} class="bg-white w-full py-3 rounded-lg text-black font-semibold mt-5 text-sm">
        Go to Songs
      </button>
      </div>
    ...
    <div class="flex flex-row">
    <img src={transitionalImage} class="rounded-lg h-14 w-14"></img>
    <span class="text-left px-5 text-sm">Songs that bridge the energy of praise and the depth of worship.</span>
    </div>
    <button  onClick={() => navigate("/TransitionalSongs")} class="bg-white w-full py-3 rounded-lg text-black font-semibold mt-5 text-sm">
        Go to Songs
      </button>
      </div>
    ...
    <div class="flex flex-row">
    <img src={worshipImage} class="rounded-lg h-14 w-14"></img>
    ...
    <button  onClick={() => navigate("/CoreWorship")} class="bg-white w-full py-3 rounded-lg text-black font-semibold mt-5 text-sm">
        Go to Songs
      </button>
      </div>
